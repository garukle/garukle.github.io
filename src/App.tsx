...
export default function App() {
  ...
  const [transitionDir, setTransitionDir] = useState<'toPage' | 'toHome'>('toPage')
  const [blackoutState, setBlackoutState] = useState<'none' | 'in' | 'out'>('none')
  ...
  const renderPage = () => {
    ...
    switch (currPage) {
      case 'map':          return <MapPage onBack={goHome} entering={entering} exiting={exiting} />
      case 'blog':         return <BlogPage onBack={goHome} entering={entering} exiting={exiting} />
      case 'projects':     return <ProjectsPage onBack={goHome} entering={entering} exiting={exiting} />
      case 'achievements': return <AchievementsPage onBack={goHome} entering={entering} exiting={exiting} />
      case 'about':        return <AboutPage onBack={goHome} entering={entering} exiting={exiting} />
      default:             return null
    }
  }
