...
const links = [
  { icon: "email", label: "Email", href: "mailto:ravipgunasekara@gmail.com" },
  {
    icon: "person",
    label: "LinkedIn",
    href: "https://linkedin.com/in/rpgunasekara",
  },
      ...
      <div className="flex gap-10 p-10 pb-24">
        <div className="flex flex-col items-center gap-4 w-64 shrink-0 pt-11">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-olive-600 mt-1 font-medium">
          ...
          <div className="flex flex-col gap-2 w-full mt-2">
            {links.map((link) => (
              <a
                ...
                className="flex items-center gap-3 px-4 py-2 border-2 border-olive-500 bg-olive-400 hover:bg-olive-300 transition-colors text-olive-800 font-semibold text-sm"
              >
        ...
        <div className="flex flex-col gap-8 flex-1">
          <div>
            ...
            <p className="text-olive-700 leading-relaxed">
              Hello, hope all is well! I'm a college junior majoring in computer
              science interested in IT and cybersecurity as a whole. I'm
              exploring the vast field that it is to learn and figure out what I
              like. Enjoy the various things I discover, as well as things from
              my hobbies!
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <p className="text-olive-700">
                <span className="font-semibold">Studying: </span>Semester has
                concluded.
              </p>
              <p className="text-olive-700">
                <span className="font-semibold">Exploring: </span>Things I'm
                working on learning.
              </p>
              <p className="text-olive-700">
                <span className="font-semibold">Other: </span>Anything else I'd
                like to share.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {ongoing.map((item) => (
                <div
                  key={item.label}
                  className="flex-1 px-4 py-3 border-2 border-olive-500 bg-olive-400"
                >
                  ...
                  <div className="flex flex-col gap-1">
                    {item.value.map((v) => (
                      <p key={v} className="text-olive-800 font-medium text-sm">
                        {v}
                      </p>
                    ))}
                  </div>
